...
const HomeLoggedIn = () => {
  ...
  return <div className="overflow-hidden pt-9 pb-24 bg-slate-50">
      ...
      <main className="pb-24 mt-36 w-full bg-slate-50 max-md:pb-24 max-md:mt-10 max-md:max-w-full">
        <section className="flex flex-col items-center px-20 w-full bg-white max-md:px-5 max-md:max-w-full">
          <div className="flex z-10 flex-col mb-0 ml-3 w-full max-w-[1159px] max-md:mb-2.5 max-md:max-w-full">
                ...
                <div className="w-4/5 max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
                    <div className="flex flex-wrap gap-2.5 text-9xl tracking-tighter leading-none text-center text-neutral-800 max-md:text-4xl">
                      <img src="https://cdn.builder.io/api/v1/image/assets/e54d2759bda84710a4d50e71ff6939bd/01767757719eef5d052aeb1a221f393e2ab6a1af?placeholderIfAbsent=true" className="object-contain shrink-0 self-start mt-4 max-w-full aspect-square rounded-[90px] w-[106px]" alt="Campus Mate logo" />
                  ...
                  <div className="flex overflow-hidden flex-col py-3 mx-auto w-full bg-white border-black border-solid border-[5px] rounded-[44px] max-md:mt-10">
                    <div className="flex flex-col pr-4 pl-11 w-full text-xs text-black max-md:pl-5">
                      ...
                      <div className="flex gap-1.5 self-end mt-5">
                        ...
                        <img src="https://cdn.builder.io/api/v1/image/assets/e54d2759bda84710a4d50e71ff6939bd/cc73dc119c0b737953dad0c0fdbd47bcbf791cee?placeholderIfAbsent=true" className="object-contain shrink-0 self-start aspect-square w-[26px]" alt="Send icon" />
                      </div>
                    </div>
                    <div className="flex flex-col px-2.5 mt-3.5 w-full text-xs text-black">
                      <div className="flex gap-1">
                        <img src="https://cdn.builder.io/api/v1/image/assets/e54d2759bda84710a4d50e71ff6939bd/b27d8203ce31f13bf8f0fe8143c4cfdda9b5c164?placeholderIfAbsent=true" className="object-contain shrink-0 self-start aspect-square rounded-[90px] w-[38px]" alt="Assistant avatar" />
                      ...
                      <div className="flex gap-1.5 self-end mt-5 max-md:mr-1.5">
                        ...
                        <img src="https://cdn.builder.io/api/v1/image/assets/e54d2759bda84710a4d50e71ff6939bd/a1f84158add738f07b4ffaba4d4fc63e5bbb16b0?placeholderIfAbsent=true" className="object-contain shrink-0 self-start aspect-square w-[26px]" alt="Send icon" />
                      </div>
                    </div>
                    <div className="flex gap-1 mt-4 mr-2.5 text-xs text-black max-md:ml-2.5">
                      <img src="https://cdn.builder.io/api/v1/image/assets/e54d2759bda84710a4d50e71ff6939bd/11b4e3b612d8937de3a4065c154b64e43e787d59?placeholderIfAbsent=true" className="object-contain shrink-0 self-start aspect-square rounded-[90px] w-[38px]" alt="Assistant avatar" />
                    ...
                    <div className="flex gap-5 justify-between items-start py-1 pr-2.5 pl-1 mt-12 mr-3.5 ml-3 rounded-3xl border-2 border-solid bg-slate-600 bg-opacity-10 border-black border-opacity-0 max-md:mx-2.5 max-md:mt-10">
                      <div className="flex gap-1.5 text-xs leading-3 text-gray-800">
                        <img src="https://cdn.builder.io/api/v1/image/assets/e54d2759bda84710a4d50e71ff6939bd/ee214c25a5dbc72790c907ee1053a68caddb7947?placeholderIfAbsent=true" className="object-contain shrink-0 aspect-[1.06] w-[17px]" alt="Input icon" />
                        <label htmlFor="message" className="sr-only">Type your message</label>
                        <input type="text" id="message" placeholder="Type your message..." className="bg-transparent border-none outline-none text-xs" />
                      </div>
                      <div className="flex gap-1.5">
                        <button aria-label="Voice input">
                          <img src="https://cdn.builder.io/api/v1/image/assets/e54d2759bda84710a4d50e71ff6939bd/35055ae13a60984ceaaabfd7fe173ca5a106e22c?placeholderIfAbsent=true" className="object-contain shrink-0 w-2.5 aspect-[0.71]" alt="Voice input" />
                        </button>
                        <button aria-label="Send message">
                          <img src="https://cdn.builder.io/api/v1/image/assets/e54d2759bda84710a4d50e71ff6939bd/4534aef4d748af8c61997bff29698abd3f4c46f9?placeholderIfAbsent=true" className="object-contain shrink-0 self-start aspect-square w-[11px]" alt="Send message" />
                        </button>
                      </div>
                    </div>
            ...
            <img src="https://cdn.builder.io/api/v1/image/assets/e54d2759bda84710a4d50e71ff6939bd/a48df6a4a3cbb6c5268aaf09bd426e03e54a68fd?placeholderIfAbsent=true" className="object-contain self-center mt-7 ml-5 w-full aspect-[1.6] max-w-[1011px] max-md:max-w-full" alt="Campus Mate features" />
          </div>
        </section>
      </main>
      ...
      <ModeSelectionModal isOpen={isModeSelectionOpen} onClose={() => setIsModeSelectionOpen(false)} />
    </div>;
};
